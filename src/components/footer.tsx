...
export default function FooterSection() {
    return (
        <>
            <section className="bg-linear-to-b from-backgroundt to-muted dark:to-card relative from-50% to-50% pt-12 md:pt-24">
            ...
            <footer
                role="contentinfo"
                className="bg-muted dark:bg-card py-12 sm:py-20">
